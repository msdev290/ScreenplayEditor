...
import { Tab } from "../EditorAndSidebar";
    ...
    <div className={join(sidebar.container, sidebar.tabs)}>
      <div className={sidebar.tabs}>
        <div className={sidebar.style_btns}>
          <div
            className={join(sidebar.style_btn, boldActive)}
            onClick={toggleBold}
          >
            <BoldSVG className={sidebar.style_btn_img} />
          </div>
          <div
            className={join(sidebar.style_btn, italicActive)}
        ...
        />
        <EditorTab
          action={() => setActiveTab("shot")}
          content="Shot"
          active={tabs[selectedTab] == "shot"}
        />
        <EditorTab
          action={() => setActiveTab("text")}
          content="Text"
          active={tabs[selectedTab] == "text"}
        />
      </div>
    </div>
  );
